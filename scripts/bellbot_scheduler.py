...
if __name__ == '__main__':
    ...
    try:
        ...
        task = Task(start_node_id="WayPoint4", action='bellbot_action_server')
        task_utils.add_int_argument(task, '2')
        task_utils.add_string_argument(task, 'WayPoint4')
        task_utils.add_string_argument(task, '')
        task_utils.add_string_argument(task, 'Meaningfull description')
